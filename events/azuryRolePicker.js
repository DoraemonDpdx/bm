...
client.on("interactionCreate", async (interaction) => {
  ...
  const redRole = "983011884804497459";
  const blueRole = "983011883923681280";
  const greenRole = "983011880186564688";
  const yellowRole = "983011878991188020";
  const heRole = "983011838935592960";
  const sheRole = "983011836905521172";
  const theyRole = "983011839967383582";
  const askRole = "983011839967383582";
  const annRole = "983011876474585128";
  const eventRole = "983011871449829396";
  const wakeRole = "983011872439689247";
    if(interaction.customId == `azu_rolepicker`) {
      ...
      interaction.reply({ content: `<a:yes:906785808940425267> **Successfuly added the role!**`, ephemeral: true })

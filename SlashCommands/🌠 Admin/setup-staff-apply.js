...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      ...
      .setAuthor({ name: `Dpdx Staff Application`, iconURL: `${client.user.displayAvatarURL()}` })
      .setColor('#2f3136')
      .setFooter(`Made with 💖 by discord.dpdxgamer.ga`) 
      .setDescription(`**Apply for a <@&931653129550823514> where you can help moderate Dpdx! And even get to a high respectable rank!**\n\n***Click the \`button\` below to open a application ticket!***`)

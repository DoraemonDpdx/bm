    ...
    run: async (client, interaction, args) => {
      ...
      const row = new MessageActionRow()
			.addComponents(
			  ...
			  .setPlaceholder('Report a Bug/ Get support / Claim a giveaway')
			  .addOptions([
          ...
          { label: `Bug Report`, description: `Want to report a bug? Click below to report a bug!`, value: `ord_order`, emoji: `937441297923469342` },
        ]),
			);

...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      if(!interaction.member.roles.cache.has("983011779871375361")) return interaction.followUp(`❌ **Only BOT CREATORS can use this command!**`)
      return interaction.followUp(`<a:Loading:920516789883002880> **This command is coming soon! Please create the bot at https://admin.dpdxgamer.ga**`)

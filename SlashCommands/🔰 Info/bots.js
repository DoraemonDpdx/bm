...
module.exports = {
    name: "bots",
    description: "🤖 View a user's bots in admin.dpdxgamer.ga",
    type: 'CHAT_INPUT',
    options: [
      {
        name: "user",
    ...
    msg.edit({ content: ` `,
      embeds: [
        ...
        .addField("<:blurple_bot:949844029720371280> Discord Bot: **|** <:plus:949844502598791178> Bot Invite:", `${botmaped.join('\n')}`)
        .setColor("GREEN")
        .setFooter(client.botFooter, client.botFooterIcon) 
        .setTimestamp()
      ]
